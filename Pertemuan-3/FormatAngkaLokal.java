...
public class FormatAngkaLokal{
 ...
 System.out.println("double Angka = "+ Angka +" berformat number (GERMANY) : "+NumberStrGERMANY);
 System.out.println("double Angka = "+ Angka +" berformat currency (GERMANY) : "+CurrStrGERMANY);
 System.out.println("double Angka = "+ AngkaPecahan +" berformat percent (GERMANY) : "+PercentStrGERMANY);
 System.out.println();
    System.out.println();
    ...
    System.out.println("double Angka = "+ Angka +" berformat number (US) : "+NumberStrUS);
    System.out.println("double Angka = "+ Angka +" berformat currency (US) : "+CurrStrUS);
    System.out.println("double Angka = "+ AngkaPecahan +" berformat percent (US) : "+PercentStrUS);
}
}